...
class WishlistsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist" do
    assert_difference('Wishlist.count') do
      post wishlists_url, params: { wishlist: { attraction_id: @wishlist.attraction_id, profile_id: @wishlist.profile_id } }
    end
  ...
  test "should update wishlist" do
    patch wishlist_url(@wishlist), params: { wishlist: { attraction_id: @wishlist.attraction_id, profile_id: @wishlist.profile_id } }
