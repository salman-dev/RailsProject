...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { city: @attraction.city, description: @attraction.description, name: @attraction.name, picture: @attraction.picture } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { city: @attraction.city, description: @attraction.description, name: @attraction.name, picture: @attraction.picture } }
