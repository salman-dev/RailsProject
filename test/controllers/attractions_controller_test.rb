...
class AttractionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post attractions_url, params: { attraction: { description: @attraction.description, location_id: @attraction.location_id, name: @attraction.name, picture: @attraction.picture } }
    end
  ...
  test "should update attraction" do
    patch attraction_url(@attraction), params: { attraction: { description: @attraction.description, location_id: @attraction.location_id, name: @attraction.name, picture: @attraction.picture } }
